...
public class FactionInfo {
    ...
    public static void FactionInfo(Player sender, String UUID, String[] args) {
        new Thread( () -> {
            ...
            String FactionBeaconInfo = "";
            if(FactionUtils.hasMainBeacon(TargetFactionUUID)) {
                String coords = FactionUtils.getMainBeaconStringLocation(TargetFactionUUID).split("===")[1];
                Location beaconloc = SystemUtils.string2loc(coords);
                String yescords = "(월드:" + beaconloc.getWorld().getName() + " X:" + beaconloc.getX() + " Y:" + beaconloc.getY() + " Z:" + beaconloc.getZ() + ")";
                FactionBeaconInfo = yescords;
            } else {
                FactionBeaconInfo = "국가 신호기가 존재하지 않습니다. 중립국";
            }
            if(!FactionUtils.isInWar(TargetFactionUUID)) {
                SystemUtils.sendmessage(sender, "&r&f&m-----------------&r&a&o&l[ &r&f국가 &r&a&o&l]&r&f&m-----------------\n" +
                        ...
                        "&r\n" +
                        "&r&7&l> &r 국가 신호기 좌표 &r&8&l: &7" + FactionBeaconInfo + "&r\n" +
                        "&r\n" +
                ...
                SystemUtils.sendmessage(sender, "&r&f&m-----------------&r&a&o&l[ &r&f국가 &r&a&o&l]&r&f&m-----------------\n" +
                        ...
                        "&r&7&l> &r 국가 신호기 좌표 &r&8&l: &7" + FactionBeaconInfo + "&r\n" +
                        "&r\n" +
                        "&r&7&l> &r 전쟁 상대 국가 &r&8&l: &c" + FactionUtils.getCappedFactionName(FactionUtils.getOPPWar(TargetFactionUUID)) + "\n" +
                        "&r\n" +
                        "&r&7&l> &r 금고잔액 &r&8&l: &7" + df.format(faction.getBank()) + "\n" +
                        "&r&7&l> &r 남은파워 &r&8&l: &7" + faction.getDTR() + "&f/&7100.0\n" +
                        "&r&7&l> &r 설립일 &r&8&l: &7" + SystemUtils.FactionUUIDToDate(TargetFactionUUID) + "\n" +
